const List = ({user_id,user,current_balance}) => {

   

    return ( 
       <>
        <li className="list-group-item" key={user_id}>
         <div className="row w-100">
             ...
             <label className="name lead">Wellcome</label>
             <br /> 
             ...
             <span className="text-muted small text-truncate">${current_balance}</span>
             </div>
         </div>
      </li>
       </>
